...
- As a user, I want to be able to add a date and description of the type of credit it was (the category it falls under), 
  and the amount
- As a user, I want to be able to add a date and description of the type of debt it was (the category it falls under),
  and the amount
- As a user, I want to e able to select an account and lookup transactions (credit/debt) for a given date